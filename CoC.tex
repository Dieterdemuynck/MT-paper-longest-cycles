...
% --TO BE FILLED IN--
\noindent
\textbf{Student name:} Dieter Demuynck \hfill \textbf{Student number:} r0829992
...
\begin{tabularx}{\linewidth}{@{}lXlX@{}}
\textbf{Title Bachelor’s or Master’s thesis:} & & \textbf{Supervisor:} & \\
Graphs and their cycle intersections & & Jan Goedgebeur &  \\
& & Jorik Jooken & \\
& & Carol T.\ Zamfirescu \\
\end{tabularx}
...
X I \textbf{did use} GenAI Assistance. In this case \textbf{specify which ones} (e.g.\ ChatGPT, M365 Copilot, …): ChatGPT, Claude
...
\textbf{As a language assistant for reviewing or improving texts I wrote myself} & \textit{ChatGPT and Claude, for finding grammatical issues and reviewing and proofreading the texts written, so errors could easily be fixed.} & This use is similar to using spelling and grammar check tools. In general, you do not have to refer to such kind of GenAI use in the text. 
...
\end{itemize} \\ \hline
\textbf{For literature search} & \textit{ChatGPT, to find sources for claims believed to be true, and to find links or websites which give a BibTeX entry for known sources.} & This use is comparable to e.g.\ a Google Scholar search. You do not have to refer to such kind of GenAI use; \textbf{you only have to \href{https://bib.kuleuven.be/english/training-and-tutorials/citation}{refer} to the literature references you have checked and used} (without such references you would be committing \href{https://www.kuleuven.be/english/education/plagiarism/index}{plagiarism} and thus committing an irregularity).
...
} & \textit{/} & According to Article 84 of the Regulations on Education and Examinations your text should allow to correctly and properly assess your own knowledge, understanding and skills. \textbf{Therefore, inserting blocks of text without quotes and a reference to GenAI assistance in your work is not allowed. }
...
\end{itemize} \\ \hline
\textbf{For generating visuals, video or audio} & \textit{/} & Use of GenAI for generating visuals, audio or video is allowed except when it is prohibited by the teacher or the program of study. 
